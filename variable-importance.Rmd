...
## VarImpact() analysis (broken right now)

```{r analysis, error=T, eval=F}
# This block is currently generating an error, but continue to later blocks.
...
# X minutes on 4 cores; X minutes on 24 cores; X minutes on 96 cores.
# NOT working right now :/ Need to investigate.
vim = varImpact(Y, X, V=V, g.library=g_lib, Q.library=Q_lib,
